...
#define THRESHOLD \
  2 // encode string into position and length if match_length is
...
int match_position, match_length, lson[N + 1], rson[N + 257],
    dad[N + 1]; // left & right children & parents -- These
